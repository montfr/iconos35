...
final class MovieSeriesModel extends Model {
  ...
  public function read_movies ( $id = '' ) {
    $this->sql = ( $id != '' )
      ? "SELECT * FROM movie_series WHERE imdb_id = '$id' AND category = 'Movie"
      : "SELECT * FROM movie_series WHERE category = 'Movie'";
    ...
    public function read_series ( $id = '' ) {
    $this->sql = ( $id != '' )
      ? "SELECT * FROM movie_series WHERE imdb_id = '$id' AND category = 'Serie"
      : "SELECT * FROM movie_series WHERE category = 'Serie'";
